;; -*- lisp-version: "10.1 [64-bit Windows *SMP*] (Sep 16, 2023 12:47)"; -*-

(in-package :cg-user)

(define-project :name :iri
  :modules (list (make-instance 'module :name "IRIutils.lisp")
                 (make-instance 'module :name "IRIstring.lisp")
                 (make-instance 'module :name "IRIstructure.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
